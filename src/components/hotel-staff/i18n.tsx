...
const translations: Record<string, Record<Locale, string>> = {
  ...
  // Statuses - system-assigned, non-editable
  ...
  // Status descriptions (legend) - system-authoritative tone
  ...
  // Check-in screen - no approve/reject, photo capture only
  ...
  // Photo capture - primary action, auto-finalizes
  ...
  // Success - system-completed, declarative tone
